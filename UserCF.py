...
def readFile(filename):
    files = open(filename, "r", encoding="iso-8859-15")#, encoding="utf-8"
    # 如果读取不成功试一下
...
# -------------------------开始-------------------------------
start = time.clock()
movies = readFile("F:/2018/continue/RS/CF/ml-1m/movies.dat")
ratings = readFile("F:/2018/continue/RS/CF/ml-1m/ratings.dat")
